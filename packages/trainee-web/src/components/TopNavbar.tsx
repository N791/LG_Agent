      ...
      <div className="flex items-center space-x-4">
        ...
        {title && (
          <div className="flex items-center">
            ...
            {status && (
              <div className={`ml-3 text-xs px-2 py-0.5 rounded-full ${status === 'Saved' ? 'bg-green-900/50 text-green-400 border border-green-800' : 'bg-yellow-900/50 text-yellow-400 border border-yellow-800'}`}>
                {status}
              </div>
            )}
          </div>
