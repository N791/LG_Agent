...
export const updateUser = (id: string, data: Record<string, unknown>) => request.patch(`/users/${id}`, data);
export const deleteUser = (id: string) => request.delete(`/users/${id}`);

// Organizations
export const getOrganizations = () => request.get('/organizations');
export const createOrganization = (data: Record<string, unknown>) => request.post('/organizations', data);
export const updateOrganization = (id: string, data: Record<string, unknown>) => request.patch(`/organizations/${id}`, data);
...
export const updateCourse = (id: string, data: Record<string, unknown>) => request.patch(`/courses/${id}`, data);
...
export const updateTask = (id: string, data: Record<string, unknown>) => request.patch(`/tasks/${id}`, data);
